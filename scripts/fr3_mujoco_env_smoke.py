                ...
                pformat(
                    {
                        ...
                        "otg_enabled": info["otg_enabled"],
                        "otg_steps": info["otg_steps"],
                        "sender_steps": info["sender_steps"],
                        "target_pose_7d": np.asarray(info["target_pose_7d"]).round(6).tolist(),
                        "tcp_pose_7d": np.asarray(info["tcp_pose_7d"]).round(6).tolist(),
                        "target_joint_positions": np.asarray(info["target_joint_positions"]).round(6).tolist(),
                        "joint_positions": np.asarray(info["joint_positions"]).round(6).tolist(),
                        "reward": reward,
