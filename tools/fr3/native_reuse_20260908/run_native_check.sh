...
export PYTHONPATH="/home/nvidia/Code/infer/.venv-fr3/lib/python3.12/site-packages/cmeel.prefix/lib/python3.12/site-packages"
...
exec "$ROOT/planner_env/bin/python" "$ROOT/prepare_native.py" "$@"
