#!/usr/bin/env python3
"""
Run FR3 DAS move_to_start inside the repository Docker runtime.
"""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run FR3 DAS move_to_start inside Docker.")
...
def build_docker_command(args: argparse.Namespace) -> list[str]:
    ...
    runtime_args = [
        ...
        "tools/fr3/fr3_move_to_das_start_runtime.py",
