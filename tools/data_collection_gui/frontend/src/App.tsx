  ...
  return (
    <section className="panel real-robot-panel">
      <div className="panel-heading">
        ...
        <span>opencv_kalibr cube replay · automatic RealSense monitor</span>
      </div>
            ...
            {status.datasetKind === "exported"
              ...
              : !validationMatches
                ...
                : !ipValid
                  ...
                  : "The gateway will preflight this robot IP, then run run_replay_cube_pose_on_thor.sh."}
          </p>
        </div>
  ...
  const pageNode =
    activePage === "live-record" ? (
      ...
      <EpisodeReplayPage
        ...
        onRealReplay={(mode, robotIp) =>
          run(() => api.startRealCubeReplay(mode, robotIp))
        }
