...
## Follow-up Configs (Round 2)
- cvc8migk fix: src/lerobot/scripts/train_config/diffusion_fr3_ot_cvc8migk_fix.json
  - Changes: lr→1e-4, warmup_steps→5000 (OT unchanged)
- pj1f7xs4 fix: src/lerobot/scripts/train_config/diffusion_fr3_ot_pj1f7xs4_fix.json
  - Changes: action_lbl.weight_label→0.003, reg→0.05, lambda_ot→0.08
