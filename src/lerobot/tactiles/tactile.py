...
class Tactile(abc.ABC):

    def __init__(self, config: TactileConfig):
        self.fps: int | None = config.fps
        self.num_taxels: int | None = config.num_taxels
        self.num_dimensions: int | None = config.num_dimensions

    def __enter__(self):
        """
        Context manager entry.
        Automatically connects to the tactile.
        """
        self.connect()
        return self
    ...
    def is_connected(self) -> bool:
        """Check if the tactile is currently connected.

        Returns:
            bool: True if the tactile is connected and ready to capture frames,
                  False otherwise.
        """
        pass
    ...
    def find_tactiles() -> list[dict[str, Any]]:
        """Detects available tactiles connected to the system.
        Returns:
            List[Dict[str, Any]]: A list of dictionaries,
            where each dictionary contains information about a detected tactile.
        """
        pass

    @abc.abstractmethod
    def connect(self, warmup: bool = True) -> None:
        """Establish connection to the tactile.

        Args:
            warmup: If True (default), captures a warmup frame before returning. Useful
                   for tactiles that require time to adjust capture settings.
    ...
    def read(self) -> NDArray[Any]:
        """Capture and return a single frame from the tactile synchronously.
    ...
    def async_read(self, timeout_ms: float = ...) -> NDArray[Any]:
        ...
        Usage:
            ...
            is fresh, effectively synchronizing your loop to the tactile's FPS.
            - Causes of a timeout usually include: very low tactile FPS, heavy processing load,
            or if the tactile is disconnected.
    ...
    def read_latest(self, max_age_ms: int = 500) -> NDArray[Any]:
        ...
        meaning it could have been captured a while ago (hanging tactile scenario e.g.).
        ...
        Raises:
            ...
            NotConnectedError: If the tactile is not connected.
            RuntimeError: If the tactile is connected but has not captured any frames yet.
        """
        warnings.warn(
    ...
    def disconnect(self) -> None:
        """Disconnect from the tactile and release resources."""
        pass
