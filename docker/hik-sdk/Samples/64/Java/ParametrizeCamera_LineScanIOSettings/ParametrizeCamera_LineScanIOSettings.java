...
public class ParametrizeCamera_LineScanIOSettings
{
    ...
    private static void printDeviceInfo(MV_CC_DEVICE_INFO deviceInfo)
    {
        if (null == deviceInfo) {
            System.out.println("deviceInfo  is null");
            return;
        }
       ...
       if ((deviceInfo.transportLayerType == MV_GIGE_DEVICE) || (deviceInfo.transportLayerType == MV_GENTL_GIGE_DEVICE))
        ...
        System.out.println("\tAccessible:      "
            + MvCameraControl.MV_CC_IsDeviceAccessible(deviceInfo, MV_ACCESS_Exclusive));
        System.out.println("");
    }
